...
def downloadhtml(url):
  ...
  file=open("./data-2000/urllist.html","w",encoding="utf-8")
    ...
    if url != None:
      if re.search('.xls',url) != None:
        ...
        if url not in xls_set:
          xls_set.add(url)
          url = 'http://www.stats.gov.cn/tjsj/pcsj/rkpc/5rp/' + url
          savefilename = './data-2000/' + xlsfilename + '.xls'
          # print(url)
          # print(savefilename)
          # 下载xls文件
...
#   下载html文件
  excellisturl = "http://www.stats.gov.cn/tjsj/pcsj/rkpc/5rp/left1.htm"
  downloadhtml(excellisturl)
  downloaddata(r'./data-2000/urllist.html')
